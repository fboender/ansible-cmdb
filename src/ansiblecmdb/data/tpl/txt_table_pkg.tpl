...
cols = [
  ...
  {"title": "curl",       "id": "curl",       "visible": True, "field": lambda h: host['ansible_facts'].get('packages', {}).get('curl', [{}])[0].get('version', '')},
  {"title": "wget",       "id": "wget",       "visible": True, "field": lambda h: host['ansible_facts'].get('packages', {}).get('wget', [{}])[0].get('version', '')},
