...
echo "python2 ../src/ansible-cmdb -t markdown -i hosts out > gen_markdown_3.csv"
python2 ../src/ansible-cmdb -t markdown -i hosts out > gen_markdown_3.csv
...
echo "python3 ../src/ansible-cmdb -t markdown -i hosts out > gen_markdown_3.csv"
python3 ../src/ansible-cmdb -t markdown -i hosts out > gen_markdown_3.csv
